...
def test_choose_existing_table_prefers_legacy_candidate_when_configured_missing():
    existing = {"decisions", "round_history", "fusion222_v1366_decisions"}
    columns = {
        "decisions": {"betting_epoch", "signal", "selected_ev", "probability_up", "probability_down", "strategy_version", "settled", "final_winner"},
        "fusion222_v1366_decisions": {"betting_epoch", "signal", "selected_ev", "probability_up", "probability_down", "strategy_version", "settled", "final_winner"},
    }
