...
def test_private_write_tables_and_main_read_source():
    ...
    assert names["decisions"] == "fusion222_v1366_nobreaker_decisions"
    assert names["state"] == "fusion222_v1366_nobreaker_state"
    assert names["snapshots"] == "fusion222_v1366_nobreaker_snapshots"
